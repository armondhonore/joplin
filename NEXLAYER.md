...
**Live:** [https://relaxed-weasel-joplin.cloud.nexlayer.ai](https://relaxed-weasel-joplin.cloud.nexlayer.ai)  
...
**joplin** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/joplin/server:latest
    path: /
    servicePorts:
    - 22300
    vars:
      APP_PORT: "22300"
      APP_BASE_URL: "https://relaxed-weasel-joplin.cloud.nexlayer.ai"
      DB_CLIENT: pg
